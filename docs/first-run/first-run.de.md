...
Wir konnten das Konto nicht anlegen. Prüfe die Angaben und versuch es erneut — dir wurde nichts berechnet.

**`auth.signup.mustAgreeToTerms`**

> EN — You must agree to the Terms of Service and Privacy Policy to create an account.

Sie müssen den Nutzungsbedingungen und der Datenschutzerklärung zustimmen, um ein Konto zu erstellen.
...
Wir konnten dich nicht anmelden. Prüfe E-Mail und Passwort, oder setze das Passwort zurück, wenn du unsicher bist.

**`auth.login.oauthFailed`**

> EN — That sign-in didn't complete. Try again, or use your email and password below.

Diese Anmeldung wurde nicht abgeschlossen. Versuche es erneut oder nutze unten E-Mail und Passwort.
...
Bring echte Daten mit, und die KI sagt dir in zwei Minuten etwas über dein Geschäft.
...
Deine Daten bleiben deine. Sie werden privat gespeichert, nur du kannst sie lesen, und sie werden nie zum Training verwendet. Du kannst sie oder dein ganzes Konto jederzeit löschen.
...
Nur echte Muster aus dem, was du gerade importiert hast. Reicht es für keine sichere Aussage, sagen wir das.
...
CSV oder tabgetrennt, bis {max}. Wir lesen es und zeigen dir das Ergebnis, bevor etwas gespeichert wird.
...
Deine Daten könnten Tag/Monat oder Monat/Tag sein — alle liegen am oder vor dem 12., wir können es nicht erkennen. Was ist es?

**`dashboard.onboarding.firstFree`**

> EN — Your first import and analysis are free — they will not use any credits.

Dein erster Import und die Analyse sind kostenlos — dafür werden keine Credits verbraucht.
...
Hier ist noch zu wenig, um von einem Muster zu sprechen. Ein paar Dutzend Zeilen mit Datum sind meist der Punkt, ab dem sich etwas zeigt — und wir sagen lieber nichts, als etwas zu erfinden.
...
Ein Businessplan, Meeting-Notizen, eine Kundenliste. Wir holen heraus, was erfassbar ist, und lassen den Rest.

**`dashboard.onboarding.sourceCsvHint`**

> EN — A CSV export from your broker, bank or CRM. We work out what each column is.

Ein CSV-Export von Broker, Bank oder CRM. Wir erkennen, was jede Spalte ist.

**`dashboard.onboarding.sourceIntro`**

> EN — Pick whichever is easiest. Nothing here is required, and you can add more later.

Nimm, was am einfachsten ist. Nichts davon ist Pflicht, und du kannst später mehr hinzufügen.

**`dashboard.onboarding.sourcePasteHint`**

> EN — A business plan, notes, a list — we pull the structured bits out.

Ein Businessplan, Notizen, eine Liste — wir holen die strukturierten Teile heraus.
...
Die neuesten {count, number} werden angezeigt. Ältere Einträge sind weiterhin gespeichert — nutzen Sie die Suche in Ihren Einträgen, um sie zu finden.

**`dashboard.create.looksLikeQuestion`**

> EN — That looks like a question. Should I answer it, or record it?

Das sieht nach einer Frage aus. Soll ich sie beantworten oder ablegen?
...
Bitte wählen Sie ein Passwort, das alle oben genannten Anforderungen erfüllt.
...
Wähle Professional oder Ultimate als Basisplan

**`pricing.businessFeatureFreeOnUltimate`**

> EN — Team seats included free on Ultimate

Team-Plätze bei Ultimate kostenlos inklusive
...
Verwalte Plätze jederzeit in den Team-Einstellungen

**`pricing.businessSubtitle`**

> EN — For teams building together

Für Teams, die gemeinsam aufbauen
...
Melde dich an, um das Geteilte zu speichern.
...
Suche nach Mustern in deinen Daten…
...
{ready} von {total} Zeilen sind bereit
...
Eine Agentur oder ein kleines Unternehmen

**`dashboard.onboarding.goals.freelance`**

> EN — Freelance income and clients

Freelance-Einnahmen und Kunden
...
Was möchtest du vor allem im Blick behalten?
...
{count, plural, one {# Zeile importieren} other {# Zeilen importieren}}

**`dashboard.onboarding.insightsError`**

> EN — The analysis did not finish.

Die Analyse wurde nicht abgeschlossen.
...
Tabellen dürfen höchstens {max} groß sein.

**`dashboard.onboarding.truncated`**

> EN — only the first rows were read

nur die ersten Zeilen wurden gelesen

**`promise.oneSentence`**

> EN — The AI that already knows your work. Ask it anything.

Die KI, die Ihre Arbeit schon kennt. Fragen Sie sie alles.
...
Verbleibende Credits — mehr in den Einstellungen kaufen
...
{message} — mit Enter ausblenden

**`common.jumpToPage`**

> EN — Jump to a module or page...

Zu einem Modul oder einer Seite springen...
...
Auf dieser Seite aktualisiert sich nichts.

**`common.offline.showingCachedAge`**

> EN — Nothing here is updating — this was loaded {minutes} min ago.

Hier aktualisiert sich nichts — geladen vor {minutes} Min.
...
Inhaberzugang — unbegrenzte Credits
...
Kostenlose Nachricht · {count} übrig diesen Monat

**`credits.unlimited`**

> EN — Unlimited — no credits used

Unbegrenzt — keine Credits verbraucht

**`credits.unlimitedWouldHaveCost`**

> EN — Unlimited — would have cost {count, plural, one {# credit} other {# credits}}

Unbegrenzt — hätte {count, plural, one {# Credit} other {# Credits}} gekostet

**`credits.used`**

> EN — {count, plural, one {Used # credit} other {Used # credits}}

{count, plural, one {# Credit verbraucht} other {# Credits verbraucht}}

**`credits.usedWithRemaining`**

> EN — {count, plural, one {Used # credit} other {Used # credits}} · {remaining} left

{count, plural, one {# Credit verbraucht} other {# Credits verbraucht}} · {remaining} übrig
...
Überspringen und trotzdem speichern
...
Beschreibe deine Idee ausführlich...
...
aus {count, plural, one {# deiner Einträge} other {# deiner Einträge}}
...
Das konnte nicht ausgeblendet werden.
...
jetzt aufladen, damit nichts stockt.

**`credits.low.none`**

> EN — No credits left this month

Keine Credits mehr diesen Monat

**`credits.low.remaining`**

> EN — {count, plural, one {# credit left} other {# credits left}} this month

Noch {count, plural, one {# Credit} other {# Credits}} diesen Monat
...
Die Sprache konnte nicht gespeichert werden – es wurde nichts geändert.
...
Auf den Startbildschirm legen — Vollbild und Benachrichtigungen, die wirklich ankommen.
...
Safari bietet das nie von selbst an — es sind drei Tipps.
...
Tippen Sie in der Safari-Leiste auf „Teilen“
...
Tippen Sie auf „Hinzufügen“ — Ionexa erscheint bei Ihren anderen Apps

**`pwa.iosTitle`**

> EN — Add Ionexa to your Home Screen

Ionexa zum Home-Bildschirm hinzufügen

**`pwa.iosWhy`**

> EN — Until you do, iPhone cannot send you notifications, and Safari may clear your saved work after 7 unused days.

Bis dahin kann Ihr iPhone keine Benachrichtigungen senden, und Safari löscht gespeicherte Daten unter Umständen nach 7 ungenutzten Tagen.
...
Diese Aktion braucht mehr Credits, als dir bleiben. Kaufe ein Paket oder wechsle den Tarif, um fortzufahren.
...
Dir bleiben {available} Credits, benötigt werden etwa {needed}. Kaufe ein Paket oder wechsle den Tarif.
...
{credits, plural, one {# Credit} other {# Credits}}, wenn du dort auf die Schaltfläche drückst. Jetzt wird nichts berechnet.
...
Sag ein bisschen mehr, damit es an die richtige Stelle geht.
...
Das geht zu {destination}, mit dem, was du geschrieben hast.
...
Ein neuer Service für kleine Unternehmen

**`dashboard.ideas.empty.title`**

> EN — Every idea, in one place

Jede Idee an einem Ort
...
Schreib sie auf, solange sie noch roh ist — hier wird sie bewertet, mit den anderen verglichen und bleibt erhalten, auch wenn du sie verwirfst.
...
Wie sieht die erste funktionsfähige Version aus?
...
Es wurde vermutlich gelöscht. Geh zurück zur Liste und wähle etwas anderes.
...
Es wurde protokolliert. Versuch es gleich noch einmal und wende dich an den Support, wenn es weiter passiert.

**`errors.codes.serverError.what`**

> EN — This broke on our side.

Das ist auf unserer Seite schiefgegangen.

**`errors.codes.unknown.next`**

> EN — Try again, and contact support if it happens twice.

Versuch es erneut und wende dich an den Support, wenn es zweimal passiert.

**`errors.codes.unknown.what`**

> EN — This action didn't complete.

Diese Aktion wurde nicht abgeschlossen.

**`errors.codes.unsupportedType.next`**

> EN — Convert it to PDF, DOCX, CSV or TXT and upload it again.

Wandle sie in PDF, DOCX, CSV oder TXT um und lade sie erneut hoch.
...
Das liegt an uns und ist meist innerhalb weniger Minuten behoben.

**`errors.codes.upstreamUnavailable.what`**

> EN — The AI service isn't responding right now.

Der KI-Dienst antwortet gerade nicht.

**`errors.credits.charged`**

> EN — This attempt used credits.

Dieser Versuch hat Credits verbraucht.
...
Deine Credits wurden zurückgebucht.

**`errors.credits.unverified`**

> EN — We can't confirm from here whether this was charged.

Wir können von hier aus nicht bestätigen, ob das berechnet wurde.
...
{credits, plural, one {# Credit} other {# Credits}} pro Minute Sprache
...
Es wurde nichts gesendet. Korrigiere den Text und sende ihn selbst.
...
Diese Anfrage konnte nicht gelesen werden.

**`voice.errors.capacity`**

> EN — The service is busy right now. Try again shortly.

Der Dienst ist gerade stark ausgelastet. Versuch es gleich noch einmal.

**`voice.errors.denied`**

> EN — The microphone was not allowed. You can still type.

Das Mikrofon wurde nicht erlaubt. Tippen geht weiterhin.

**`voice.errors.empty`**

> EN — Nothing could be heard in that recording.

In dieser Aufnahme war nichts zu hören.

**`voice.errors.failed`**

> EN — Voice is unavailable right now. You can still type.

Sprache ist gerade nicht verfügbar. Tippen geht weiterhin.
...
Es wurde keine Aufnahme gesendet.
...
Die Sprachminuten konnten gerade nicht geprüft werden.
...
{credits, plural, one {# Credit} other {# Credits}} pro Minute, {minutes, plural, one {# Minute} other {# Minuten}} im Monat in deinem Tarif.

**`voice.permission.editFirst`**

> EN — You read and correct the text before anything is sent.

Du liest und korrigierst den Text, bevor irgendetwas gesendet wird.

**`voice.permission.notStored`**

> EN — The audio is sent for transcription and stored nowhere — not by us, not afterwards.

Das Audio wird zur Transkription gesendet und nirgendwo gespeichert — weder bei uns noch danach.

**`voice.permission.pressToStart`**

> EN — Recording starts only when you press, and stops when you press again.

Die Aufnahme startet nur auf Knopfdruck und endet beim nächsten Druck.
...
Diese Idee löschen? Das lässt sich nicht rückgängig machen.
...
Das könnte mit {titles} zusammenhängen. Verknüpfen?
...
Diesen Eintrag ({label}) löschen? Das lässt sich nicht rückgängig machen.
...
Es hat außerdem {count, plural, one {# frühere Nachricht} other {# frühere Nachrichten}} zu diesem Eintrag gelesen
...
Stell eine Frage zu diesem Eintrag — du musst den Kontext nicht erklären, die KI hat ihn bereits.

**`askAi.placeholder`**

> EN — Ask anything about this entry...

Frag irgendetwas zu diesem Eintrag...
...
Die Verbindung wurde unterbrochen, bevor die Antwort fertig war.

**`askAi.streamInterruptedPartial`**

> EN — The connection dropped — the reply above may be incomplete.

Die Verbindung wurde unterbrochen — die obige Antwort ist möglicherweise unvollständig.

**`askAi.title`**

> EN — Ask AI about this {title}

Frag die KI zu diesem {title}
...
Mit welchem Modul möchtest du verknüpfen?
