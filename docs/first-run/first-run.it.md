...
Everything a new person reads from the signup form to the first thing the product tells them about their own data: **597 strings**. The whole product is 3121, which is why this file exists.
