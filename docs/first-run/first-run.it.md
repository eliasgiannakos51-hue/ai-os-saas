...
Everything a new person reads from the signup form to the first thing the product tells them about their own data: **601 strings**. The whole product is 3266, which is why this file exists.
