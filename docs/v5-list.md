...
loads. *Proven by:* `scripts/tests/sidebar-collapse.test.mjs` (34
checks, which EXECUTE the rules over every route in the product rather
than matching the component as text) and
`sidebar-collapse.mutation.mjs` — 15 of 15 across six dimensions.
