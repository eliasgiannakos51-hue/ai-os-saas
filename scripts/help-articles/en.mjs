...
export const EN = [
  {
    slug: "pricing-overview", href: "/pricing", category: "billing", order: 0,
  ...
  {
    slug: "change-plan", href: "/dashboard/settings", category: "billing", order: 1,
  ...
  {
    slug: "cancel", href: "/dashboard/settings", category: "billing", order: 2,
  ...
  {
    slug: "invoices", href: "/dashboard/settings", category: "billing", order: 3,
  ...
  {
    slug: "refund", href: "/dashboard/settings", category: "billing", order: 4,
  ...
  {
    slug: "what-are-credits", href: "/pricing", category: "credits", order: 0,
  ...
  {
    slug: "credit-cost-per-action", href: "/dashboard/settings", category: "credits", order: 1,
  ...
  {
    slug: "credits-ran-out", href: "/dashboard/settings", category: "credits", order: 2,
  ...
  {
    slug: "create-website", href: "/dashboard/website-builder", category: "websites", order: 0,
  ...
  {
    slug: "publish-website", href: "/dashboard/website-builder", category: "websites", order: 1,
  ...
  {
    slug: "create-agent", href: "/dashboard/agents", category: "agents", order: 0,
  ...
  {
    slug: "create-mission", href: "/dashboard/mission", category: "missions", order: 0,
  ...
  {
    slug: "invite-code", href: "/dashboard/settings", category: "account", order: 0,
  ...
  {
    slug: "upload-files", href: "/dashboard/files", category: "files", order: 0,
  ...
  {
    slug: "connect-gmail", href: "/dashboard/integrations", category: "integrations", order: 0,
  ...
  {
    slug: "languages", href: "/dashboard/settings", category: "getting-started", order: 0,
  ...
  {
    slug: "delete-account", href: "/dashboard/settings", category: "privacy", order: 0,
  ...
  {
    slug: "export-data", href: "/dashboard/settings", category: "privacy", order: 1,
  ...
  {
    slug: "data-privacy", href: "/privacy", category: "privacy", order: 2,
  ...
  {
    slug: "password-reset", href: "/login", category: "account", order: 1,
  ...
  {
    slug: "team-members", href: "/pricing", category: "account", order: 2,
  ...
  {
    slug: "notifications", href: "/dashboard/settings", category: "account", order: 3,
  ...
  {
    slug: "contact-support", href: "/dashboard/settings", category: "account", order: 4,
