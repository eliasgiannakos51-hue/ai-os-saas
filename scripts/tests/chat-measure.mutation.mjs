...
// kill deletes — this directory already lost one that way, leaving a
// mutant in src/lib/unsplash.ts. Written before anything is touched,
// healed on startup.
const SIDECAR = "scripts/tests/.chat-measure-mutation-sidecar.json";
