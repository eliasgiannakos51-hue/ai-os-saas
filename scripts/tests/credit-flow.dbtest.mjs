...
// 73 since 20260823000000_pwa_client_stats (see db-migrations.test.mjs,
// which carries the same ratchet and the reason it moved).
eq("tables in public", Number(sql(`select count(*) from pg_tables where schemaname='public'`)), 73);
eq(
