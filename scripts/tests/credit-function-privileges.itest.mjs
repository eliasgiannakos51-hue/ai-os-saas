...
try {
  ...
  file("supabase/migrations/20260805_idempotent_credit_grants.sql");
  file("supabase/migrations/20260815_purchased_credits.sql");
  ...
  file("supabase/migrations/20260815_purchased_credits.sql");
  file("supabase/migrations/20260815_purchased_credits.sql");
  check("a third and fourth run both apply cleanly", true);
