...
export function generateMetadata(): Promise<Metadata> {
  ...
  // renaming it would orphan ten translations that are already correct
  // ("Search my records", "Αναζήτηση", …). What was wrong was the HINT
  // under it, which described the other page entirely.
