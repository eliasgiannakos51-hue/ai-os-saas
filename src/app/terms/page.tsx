  ...
  return (
    <LegalLayout title="terms_of_service" updated="2026-07-29">
      <LegalSection title="1. Acceptance of Terms">
        <p>
          By creating an account or otherwise using AI_OS (&quot;the
      ...
      <LegalSection title="2. Use of Service">
        <p>
          AI_OS gives you a set of modules for logging and organizing
      ...
      <LegalSection title="3. User Data">
        <p>
          You own the content you create in AI_OS. We store it on your
      ...
      <LegalSection title="4. Limitation of Liability">
        <p>
          AI_OS is provided &quot;as is,&quot; without warranties of any
      ...
      <LegalSection title="5. Changes to Terms">
        <p>
          ...
          updated&quot; date above. Your continued use of AI_OS after a
