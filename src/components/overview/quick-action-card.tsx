...
export function QuickActionCard({
  ...
  return (
    <Link
      href={href}
      className="group flex items-center gap-3 rounded-2xl border border-border bg-panel p-4 transition-all duration-200 hover:scale-[1.015] hover:border-orange-500/40 hover:shadow-[0_0_20px_rgba(249,115,22,0.12)]"
    >
