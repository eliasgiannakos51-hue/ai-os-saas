...
export function AccessibilitySettings() {
  ...
  return (
    <div id="accessibility" className="mb-6 scroll-mt-20 space-y-4 rounded-2xl border border-border bg-panel p-5">
        ...
        <div className="mt-2.5 inline-flex flex-wrap items-center gap-0.5 rounded-full border border-border p-0.5">
          {FONT_SIZES.map((size) => (
            <button
              ...
              className={`min-h-[44px] rounded-full px-3.5 py-1.5 text-xs font-medium transition-colors duration-150 sm:min-h-0 ${
                fontSize === size
