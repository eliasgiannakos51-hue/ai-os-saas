...
//
// the input is HTML generated by a model, and the patterns below match
// TAG NAMES — <html, <details. A tag name is ASCII by the HTML
// specification, and the boundary is what stops <a matching <article.
// The prose between the tags is read by lib/seo/html-text.ts, which uses
// no boundaries.
//
