...
// TAG and ATTRIBUTE names — <title, <meta, lang=, <head. Both are ASCII
// by the HTML specification, and the boundary is what stops <head
// matching <header. No human sentence is matched here.
//
