...
//
// the input is HTML generated by a model, and the one boundary below is
// in <(script|style)\b — a tag name, ASCII by the HTML specification,
// where the boundary is what stops <style matching a tag that merely
// begins with those letters. The prose it strips out is then matched
// without one.
//
