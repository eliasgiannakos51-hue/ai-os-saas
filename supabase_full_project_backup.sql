...
-- ============================================================================
-- Integration consent (see integration_consent_migration.sql for the full
-- rationale). Mirrored here so a project restored from this one file has
-- the consent gate too — a deployment whose integration_consents table is
-- missing refuses every OAuth connect (hasActiveConsent fails closed),
-- which is safe but looks exactly like the feature being broken.
-- ============================================================================
...
-- ============================================================================
-- The affiliate programme (see affiliate_migration.sql for the rationale,
-- including why every anti-fraud rule is also an index here).
-- ============================================================================
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- The learned AI profile (see user_profile_learned_migration.sql for the
-- rationale, including why there is no insert or update policy).
-- ============================================================================
